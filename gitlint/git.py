...
def repository_root():
    ...
    try:
        ...
        root = os.path.abspath(root.decode('utf-8'))
        # print("ROOT " + root)
        return root
...
def modified_files(root, tracked_only=False, commit=None):
    ...
    # print("STATUS LINES " + str(status_lines))
    ...
    # print("MODES " + str(modes_str))
    # print("MODIFIED FILE STATUS " + str(modified_file_status))
    # print("FILENAME " + filename)
    modified_files = dict((os.path.join(root, _remove_filename_quotes(filename)), mode)
...
def _modified_files_with_commit(root, commit):
    ...
    # print("MODIFIED FILE STATUS " + modified_file_status)
...
def modified_lines(filename, extra_data, commit=None):
    ...
    # print("BLAME LINES " + str(blame_lines))
